...
export const AIChat: React.FC = () => {
  ...
  if (!isChatOpen) {
    return (
      <button
        onClick={toggleChat}
        className="fixed bottom-6 right-6 w-12 h-12 shadow-lg z-50 bg-white border-2 border-gray-300 rounded-lg p-1 cursor-pointer hover:scale-105 hover:border-gray-400 transition-all"
      >
        <img 
        ...
        <CardContent className="flex flex-col h-80">
          ...
          <div className="flex-1 overflow-y-auto space-y-3 mb-4 p-2 bg-gray-50 rounded">
            {chatMessages.length === 0 ? (
              <div className="text-center text-gray-500 text-sm mt-2 py-2 border border-gray-300 rounded-lg mx-2">
