...
export const AIChat: React.FC = () => {
  ...
  if (!isChatOpen) {
    return (
      <button
        onClick={toggleChat}
        className="fixed bottom-[98px] right-[348px] w-12 h-12 shadow-lg z-[60] bg-white border-2 border-gray-300 rounded-lg p-1 cursor-pointer hover:scale-105 hover:border-gray-400 transition-all"
      >
        <img 
