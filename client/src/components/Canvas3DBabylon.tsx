...
export const Canvas3DBabylon: React.FC<Canvas3DBabylonProps> = ({ canvas, isTransitioning }) => {
  ...
  useEffect(() => {
    ...
    // Only using GLB models now - no fallback primitive blocks needed since we have complete GLB set
    ...
    // Clean GLB-only implementation - all business logic handled by GLB models with their own materials and interactions
