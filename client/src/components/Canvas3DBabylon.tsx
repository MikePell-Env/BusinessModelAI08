          ...
          if (otherMesh !== mesh) {
            ...
            if (sectionName && adjustBMCSection) {
              ...
              if (storedOriginalHeight !== undefined) {
                ...
                console.log(`📏 RestoreSelectedState: SELECTED OBJECT ${sectionName} restored to original height (${storedOriginalHeight})`);
              } else {
                ...
                console.log(`📏 RestoreSelectedState: SELECTED OBJECT ${sectionName} using fallback height (${fallbackHeight})`);
              }
            }
          }
        });
