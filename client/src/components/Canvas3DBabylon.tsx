  ...
  useEffect(() => {
    ...
    modelLoader.loadRevenueStreams().then((model) => {
      ...
      if (model.meshes.length > 0) {
        ...
        revenueRootMesh.scaling = new Vector3(7.7, 7.7, 8); // Y-scaling matches X-scaling for consistent height
    ...
    modelLoader.loadCostStructure().then((model) => {
      ...
      if (model.meshes.length > 0) {
        ...
        costRootMesh.scaling = new Vector3(8.0, 8.0, 8); // Y-scaling matches X-scaling for consistent height
