...
export const Canvas3DBabylon: React.FC<Canvas3DBabylonProps> = ({ canvas, isTransitioning }) => {
  ...
  useEffect(() => {
    ...
    // Top-left: Key Activities - ORANGE (directly above Key Resources, closer to center)
    ...
    // Top-right: Customer Relationships - YELLOW (directly above Customer Channels)
    ...
    // Bottom-left: Key Resources - RED (directly below Key Activities)
    ...
    // Bottom-right: Customer Channels - CYAN (directly below Customer Relationships)
