...
export const Canvas3DBabylon: React.FC<Canvas3DBabylonProps> = ({ canvas, isTransitioning }) => {
  ...
  useEffect(() => {
    ...
    // Horizontal flip transform applied - negating X coordinates:
    // Key Activities (ORANGE) - flipped to RIGHT side
    ...
    // Customer Relationships (YELLOW) - flipped to LEFT side
    ...
    // Key Resources (RED) - flipped to RIGHT side
    ...
    // Customer Channels (CYAN) - flipped to LEFT side
