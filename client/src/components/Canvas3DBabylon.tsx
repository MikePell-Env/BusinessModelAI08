...
export const Canvas3DBabylon: React.FC<Canvas3DBabylonProps> = ({ canvas, isTransitioning }) => {
  ...
  useEffect(() => {
    ...
    // Inner circle elements surrounding Value Proposition (matching diagram exactly):
    // NORTH (top): Key Activities - ORANGE (slightly left of center)
    ...
    // NORTH (top): Customer Relationships - YELLOW (slightly right of center)
    ...
    // SOUTH (bottom): Key Resources - RED (slightly left of center)
    ...
    // SOUTH (bottom): Customer Channels - CYAN (slightly right of center)
