...
export class SceneSetup {
  ...
  private setupLighting(): void {
    ...
    hemisphericLight.intensity = 0.12; // Low ambient for subtle illumination
    ...
    directionalLight.intensity = 0.65; // Low intensity for softer shadows
    ...
    fillLight.intensity = 0.15; // Subtle fill light
